...
Future<dynamic> createProductFunction(ProductViewModel hiveData) async {
  try {
    var inventoryData = [];
    ...
    final QueryResult result = await Config.initializeClient().mutate(
      MutationOptions(
        document: gql(ProductGraphql.createProduct),
        variables: {
          "input": {
